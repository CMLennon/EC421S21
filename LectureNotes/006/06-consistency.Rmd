...
Our second assignment will be assigned

## Near-ish future

Midterm in two weeks (May 06.super[th])
---

# .mono[R] showcase

Need speed? .mono[R] allows essentially infinite parallelization. This is due to how R is written.

Three major packages:

- [`future`](https://github.com/HenrikBengtsson/future) and [`furrr`](https://github.com/DavisVaughan/furrr)

- `parallel` or [`parallelly`](https://github.com/HenrikBengtsson/parallelly)
...
1. We use one variable as a *proxy* for another or can only approximate that variable.
