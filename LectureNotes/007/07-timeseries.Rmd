...
2. For the regression of Consumption on GDP, give an example of a variable that would cause this regression to suffer from omitted variable bias. Explain why it could be biased.
...
The regression in $(3)$ has and R.super[2] of 0.19, and the regression in $(4)$ has and R.super[2] of 0.25. You have 100 observations.

1. Calculate the White test statistic testing heterosk. in $(1)$.
2. The critical value for the White test is 18. Finish the white test by stating your hypotheses; determine your conclusion.
---
# Example questions
## Application 2

You wrote some code last night that just won't run. You were hoping to examine a scatterplot of education and income.

Your code reads -

```{r mycode, eval = F}
plot = ggplot(data = df, aes(x = education, y = income) + geom_point())
```

What did you need to change to get the result you hoped for?
