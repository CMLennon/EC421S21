...
**Assignment** Coming Tuesday; due early next week.
...
- What .pink[caused] the wildfire?
- .pink[How] did this baby get here? `r emo::ji("baby")`
...
- What .red[causes] some countries to grow and others to decline?
- Did pandemic aid payments .red[cause] crypto-coins to increase in price?
- Did lax regulation .red[cause] Texas's recent energy problems?
- .red[How] does the number of police officers affect crime?
- What is the .red[effect] of better air quality on test scores?
- Do longer/harsher prison sentences .red[decrease] crime?
- How did cannabis legalization .red[affect] mental health/opioid addiction?
---

## Exogeneity

Another concept we need to think about is .hi-red[exogeneity]. 

When we start thinking about more complex systems of causality, we'll get into this more

--

but, for now, exogeneity is an .orange[assumption] that some causal effect is .pink[unrelated] to other causal factors.

--

We'll make this definition more concrete soon (and provide examples).
...
Although correlation is not causation, in an OLS model: .hi[causation *requires* correlation].
...
## Example: The causal effect of fertilizer.super[.pink[†]].super[.orange[†]]

.footnote[
.pink[†] Many of the early statistical and econometric studies involved agricultural/ag-product field trials.
.orange[†]Student's .hi[t] actually comes from a statistician, William Gosset at guinness `r emo::ji('beer')`
]
...
Randomized experiments help us maintain *all else equal* (exogeneity) so long as the randomization is .pink[un-associated] with other causal factors.
...
By randomizing plots of land into .hi-slate[treatment] or .hi-slate[control], we will, on average, include all kinds of land (soil, slope, water, *etc.*) in both groups.
...
.hi-slate[Next time:] What if our causal system is more complex than that?
